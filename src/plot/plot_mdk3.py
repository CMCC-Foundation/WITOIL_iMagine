...
def velovect(axes, x, y, u, v, density=1, linewidth=None, color=None,
    ...
    axes : matplotlib.axes.Axes
        The axes on which to draw the streamlines.
    x, y : 1D/2D arrays
    ...
    transform : matplotlib.transforms.Transform, optional
        Transformation applied to streamline coordinates. By default, uses 
        data coordinates.
    minlength : float
    ...
    grains : int or tuple of ints, default=15
        Controls the number of starting points in each direction. Higher values create 
        a denser grid of starting points.
    ...
    for t in trajectories:
        ...
        n = np.searchsorted(s, s[-1]) #Position arrow on line
